    ...
    return (
        <>{
            ...
            <section className='info-container'>
                        ...
                        <div className='img-list'>
                                {
                                    imgInfo && imgInfo.map((obj, key) => {
                                        return <figure key={obj.PHOTO_NO} onClick={() => changImg(key)}><img src={obj.PHOTO_URL}></img></figure>
                                    })
                                }
                            </div>
                    </div>
                ...
                {
                    <Link to="/AnimalList"><button style={{backgroundImage :`url(${process.env.PUBLIC_URL + info.SPCS == 'DOG' ? "../img/bone.svg" :"../img/fishbone.svg" })`}}>목록</button></Link>
                }
